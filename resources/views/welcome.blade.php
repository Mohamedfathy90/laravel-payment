    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    <div class="small mb-1">SKU: BST-600</div>
                    <h1 class="display-5 fw-bolder">Shop item template</h1>
                    <div class="fs-5 mb-5">
                    <label>Price</label>
                    <input class="form-control text-center me-3" id="inputprice" type="num" value="100" style="max-width: 4rem" />
                    ...
                    <div class="">
                            <div class="row">
                                ...
                                <form id="paypal_form" action="/paypal-payment" method="POST">
                                        @csrf
                                        <input id="price_paypal" type="hidden" value="100" name="price">
                                        <input id="quantity_paypal" type="hidden" value="1" name="quantity">
                                ...
                                <div class="col-md-4 my-2">
                                    <form id="stripe_form" action="/stripe-payment" method="POST">
                                        @csrf
                                        <input id="price_stripe" type="hidden" value="100" name="price">
                                        <input id="quantity_stripe" type="hidden" value="1" name="quantity">
                                        <button type="submit" class="btn btn-outline-dark flex-shrink-0" >
                                            <i class="bi-cart-fill me-1"></i>
                                            Buy With Stripe
                                        </button>
